...
export default function UpdatePost() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const res = await fetch(`${import.meta.env.SERVER_DOMAIN}/api/post/getposts?postId=${postId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.SERVER_DOMAIN}/api/post/updatepost/${formData?._id}/${currentUser?._id}`, {
        method: 'PUT',
