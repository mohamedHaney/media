    ...
    return (
        <div className="max-w-4xl mx-auto p-6  rounded-lg shadow-lg my-10">
            ...
            <p className="text-center text-gray-500 text-lg mb-6">
                مرحباً بك في صقور المحاجر نعمل على توفير منصة تفاعلية تستعرض تطور الإعلام عبر الزمن وتقدم محتوى ثري يلهم الجمهور للتفاعل مع الإعلام بوعي ومسؤولية.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                       صقور المحاجر، نسعى إلى بناء مجتمع إعلامي واعٍ، يشجع على التفاعل المسؤول مع المعلومات ويعزز التفكير النقدي. نتطلع إلى سد الفجوة بين الماضي والحاضر عبر تقديم محتوى تفاعلي يبرز دور الإعلام في تشكيل المجتمع والثقافة.
                    </p>
                </div>
