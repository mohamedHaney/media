...
export default function DashboardComp() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch(`https://mdia1-3pokryme.b4a.run/api/user/getusers?limit=5`);
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch(`https://mdia1-3pokryme.b4a.run/api/post/getposts?limit=5`);
        const data = await res.json();
        if (res.ok) {
          setPosts(data.posts);
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(`https://mdia1-3pokryme.b4a.run/api/comment/getcomments?limit=5`);
        const data = await res.json();
        if (res.ok) {
