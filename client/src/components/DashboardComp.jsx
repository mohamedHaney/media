...
export default function DashboardComp() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch(`https://media-one-rust.vercel.app/api/user/getusers?limit=5`);
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch(`https://media-one-rust.vercel.app/api/post/getposts?limit=5`);
        const data = await res.json();
        if (res.ok) {
          setPosts(data.posts);
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(`https://media-one-rust.vercel.app/api/comment/getcomments?limit=5`);
        const data = await res.json();
        if (res.ok) {
